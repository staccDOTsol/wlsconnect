    ...
    return queryInterface.bulkInsert('apps', [
      {
        ...
        owner: 'siol',
        redirect_uris: JSON.stringify(['http://localhost:3000/demo', 'http://localhost:3000', 'https://sc2-angular.herokuapp.com', 'https://v2.whalesharesconnect.com3000/demo', 'https://busy.org/callback']),
        name: 'Busy.org',
