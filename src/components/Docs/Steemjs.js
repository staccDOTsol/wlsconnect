...
import pkg from '@whaleshares/wlsjs/package.json';
import methods from '@whaleshares/wlsjs/lib/api/methods';
import operations from '@whaleshares/wlsjs/lib/broadcast/operations';
  ...
  <div className="container my-5">
    ...
    <p>
      <FormattedMessage
        ...
        values={{
          version: pkg.version,
          source: <a href="https://github.com/steemit/wlsjs"><FormattedMessage id="source_code" /></a>,
