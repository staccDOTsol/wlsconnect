      ...
      <div className="TransferInfo">
        <div className="TransferInfo__accounts">
          <div className="TransferInfo__account">
            <WhaleSharesitAvatar username={query.fromName} size="60" className="TransferInfo__avatar" />
          ...
          <div className="TransferInfo__account">
            <span className="TransferInfo__dots" />
            <WhaleSharesitAvatar username={query.toName} size="60" className="TransferInfo__avatar" />
